...
echo "dest(6)|wc -l : " `~/Scripts/dmesg_parsing/total_dmesg_parser_exp.sh |grep "dest(6)" |wc -l`
echo "dest(7)|wc -l : " `~/Scripts/dmesg_parsing/total_dmesg_parser_exp.sh |grep "dest(7)" |wc -l`
